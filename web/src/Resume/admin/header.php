		  ...
		  <div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  <ul class="nav navbar-nav">
			  	<li <?php if($page=="information") echo 'class="active"' ?>><a href="information.php">Insert</a></li>
				...
				<li <?php if($page=="portfolio") echo 'class="active"' ?>><a href="portfolio.php">Project</a></li>
                <li <?php if($page=="References") echo 'class="active"' ?>><a href="references.php">References</a></li>
                 <li <?php if($page=="Resume") echo 'class="active"' ?>><a href="templete.php">Resume</a></li>
