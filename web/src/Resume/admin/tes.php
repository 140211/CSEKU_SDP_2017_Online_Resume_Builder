<?php
	...
	if(isset($_POST['profilePicSubmit'])) {
		...
		{
			// "INSERT INTO user(uname, upass) VALUES( '" . $email . "', '" . md5($password) . "')")) {
			$query="update personal set image='$datatarget' where uid=1";
		// $query="update personal set image='$datatarget' where uid=. $session_id";
		// $query="INSERT INTO personal(uid,image, fname, lname, designation, phone, email, website) VALUES ( '', '".$datatarget."','','',""))"
