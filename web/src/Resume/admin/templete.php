  ...
  <form name="StudentRegistration">
    ...
    <div style="position:relative; font-family: 'Trebuchet MS', sans-serif; ">
      ...
      // $result = mysqli_query($connection, "SELECT `uid`, `image`, `fname`, `lname`, `designation`, `phone`, `email`, `website`, `bloodgroup`, `datebirth` FROM personal WHERE uid = '".$id."' ");
              $result = mysqli_query($link, "SELECT `uid`, `image`, `fname`, `lname`, `designation`, `phone`, `email`, `website`, `bloodgroup`, `datebirth` FROM personal WHERE uid = 1 ");
           ...
           <img src="/edit/Resume/images/bbb.jpg" width="auto" height="95px" style="position:absolute; margin-left:470px;margin-top:-8px; border: .5px solid dimgray ;border-radius: 5px;">
    ...
    <div style="position:relative; margin-top:70px;">     
      ...
      <?php       
              $result = mysqli_query($link, "SELECT data FROM pages WHERE pid = 1 ");
              $row = mysqli_fetch_array($result);
    ...
    <table id="t01">
      ...
      <?php       
              $result = mysqli_query($link, "SELECT `uid`, `group`, `gpa`, `board`, `fromyear`, `toyear`, `college`, `course`, `description` FROM education WHERE uid = 1 and course='SSC' ");
              $row = mysqli_fetch_array($result);
      ...
      <?php       
              $result = mysqli_query($link, "SELECT `uid`, `group`, `gpa`, `board`, `fromyear`, `toyear`, `college`, `course`, `description` FROM education WHERE uid = 1 and course='HSC' ");
              $row = mysqli_fetch_array($result);
      ...
      <?php       
              $result = mysqli_query($link, "SELECT `uid`, `group`, `gpa`, `board`, `fromyear`, `toyear`, `college`, `course`, `description` FROM education WHERE uid = 1 and course='Bachelor' ");
              $row = mysqli_fetch_array($result);
    ...
    <table cellpadding="2" align="center" cellspacing="6" style="border: 2px solid dimgray;
      ...
      <?php 
        $result = mysqli_query($link, "SELECT `photo`, `title`, `subtitle`, `filter` FROM `projects` WHERE uid = 1 ");
       ?>
    ...
    <table cellpadding="2" align="left" cellspacing="2" frame="none" style="position: relative;font-family:'Alegreya Sans SC'; font-size:16px;">
      ...
      <?php 
          $result = mysqli_query($link, "SELECT `refId`, `Name`, `Designation`, `Institute`, `contact_number`, `email` FROM `reference` WHERE uid = 1 ");
              $row = mysqli_fetch_array($result);
