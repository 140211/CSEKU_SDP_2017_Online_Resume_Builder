...
?>
			<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-3">
<!-- 						<button class="btn btn-success pull-right btnNewProject" data-toggle=" " data-target=" ">Upload New Project</button> -->
					...
					<table class="table table-striped">
						...
						<tr>
							...
							<td class="proj-title"><h4>software development project</h4></td>
														<!-- <td class="proj-title"><h4>Vestibulum varius ligula</h4></td> -->
							<td class="proj-subtitle"><h5> php </h5></td>
						...
						<tr>
							...
							<td class="proj-title"><h4>Advanced programming laboratory</h4></td>
							<td class="proj-subtitle"><h5>c#</h5></td>
						...
						<tr>
							...
							<td class="proj-title"><h4>software engineering</h4></td>
							<td class="proj-subtitle"><h5>laravel</h5></td>
				  ...
				  <div class="modal-dialog" role="document">
					<div class="modal-content">
					  ...
					  <div class="modal-body">
						  ...
						  <div class="form-group">
							<label for="project-subtitle" class="control-label">Language:</label>
