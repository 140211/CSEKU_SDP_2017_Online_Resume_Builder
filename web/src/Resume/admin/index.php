...
?>
				...
				<form method="post">
					...
					<div class="form-group">
					  <div class="input-group">
						...
						<input type="text" class="form-control" name="designation" value="<?php echo ucfirst($personaldetails['bloodgroup']); ?>">
					  </div>
					</div>
				...
				<form method="post">
					...
					<div class="form-group">
					  <div class="input-group">
						...
						<input type="text" class="form-control" name="designation" value="<?php echo ucfirst($personaldetails['datebirth']); ?>">
					  </div>
					</div>
			...
			<div class="row">
				...
				<form method="post">
					...
					<!-- <textarea name="info"
					rows="10" cols="50"><?php echo $homecontent['data'] ?></textarea> -->
     					<div class="form-group clearfix">
